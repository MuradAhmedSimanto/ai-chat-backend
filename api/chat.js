export default async function handler(req, res) {
  ...
  try {
    ...
    if (isAskName) {
      return res.status(200).json({
        reply: "আমার নাম Everest Ai😊
"আপনি চাইলে আমি নিজের সম্পর্কে বলতে পারি এবং আপনার সব ধরনের প্রশ্নের উত্তর দিতে পারি। আমি কোডিং, পড়াশোনা, মজার বিষয়—প্রায় সবকিছুর সাহায্য করতে পারি।
